        ...
        <LegalContent>
          <LegalSection>
            ...
            <LegalParagraph>
              ...
              providing health & wellness membership and healthcare services. This information is provided in compliance with consumer protection 
            ...
            <LegalParagraph>
              24/7 Wellness Support Available
            </LegalParagraph>
            <LegalParagraph>
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              {process.env.REACT_APP_COMPANY_NAME} is a health & wellness membership service provider that offers exclusive wellness 
              benefits and healthcare services to members. Our services include:
            </LegalParagraph>
            <LegalList>
              <LegalListItem>
                <strong>Wellness Services:</strong> Access to 10,000+ gyms, telehealth consultations, nutrition programs, and mental health support
              </LegalListItem>
              <LegalListItem>
                <strong>Member Benefits:</strong> Exclusive wellness programs and access to member-only health benefits
              </LegalListItem>
              <LegalListItem>
                <strong>Payment Processing:</strong> Secure processing of credit card, debit card, and other payment methods for memberships
              </LegalListItem>
              <LegalListItem>
                <strong>Account Management:</strong> Tools for members to schedule appointments, track wellness activities, and update preferences
              </LegalListItem>
              <LegalListItem>
                <strong>Wellness Concierge:</strong> Personalized wellness planning assistance and customer support
              </LegalListItem>
            </LegalList>
            <LegalParagraph style={{ marginTop: '1rem' }}>
              We act as a health & wellness service provider and merchant of record for services processed through our platform. 
              Established in {process.env.REACT_APP_COMPANY_BIRTH}, we serve individuals seeking exclusive wellness programs and premium healthcare experiences.
            </LegalParagraph>
          </LegalSection>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "{process.env.REACT_APP_BRAND_NAME?.toUpperCase() || 'GOLDLEAF'} HEALTH" or "GLD*[Health Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "{process.env.REACT_APP_BRAND_NAME?.toUpperCase() || 'GOLDLEAF'} WELLNESS" or healthcare provider names for specific services
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Wellness Services:</strong> Gym access, telehealth consultations, and wellness programs are included 
                with your membership at no additional fee per service
              </LegalListItem>
              <LegalListItem>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Membership Fees:</strong> Monthly or annual membership subscription fees provide access to exclusive wellness benefits
              </LegalListItem>
              <LegalListItem>
                <strong>Service Fees:</strong> Healthcare services are included with your membership at no additional cost per visit
              </LegalListItem>
              <LegalListItem>
                <strong>No Hidden Fees:</strong> All fees are clearly displayed before you complete your membership purchase
              </LegalListItem>
              <LegalListItem>
                <strong>Currency Conversion:</strong> If applicable, currency conversion fees are disclosed before transaction completion
              </LegalListItem>
              <LegalListItem>
                <strong>Flexible Options:</strong> Any fees associated with flexible scheduling or wellness credits are disclosed 
          ...
          <LegalSection>
            ...
            <LegalParagraph>
              For any questions about this Service Disclosure or our wellness membership services:
            </LegalParagraph>
            <LegalParagraph style={{ fontWeight: 600, marginTop: '1rem' }}>
              {process.env.REACT_APP_COMPANY_NAME}
            </LegalParagraph>
